...
public:
  ...
  const std::string &on_attacking_dmg_future2_do(void);
  const std::string &on_attacking_dmg_future3_do(void);
  ...
  const std::string &on_owner_attack_dmg_future2_do(void);
  const std::string &on_owner_attack_dmg_future3_do(void);
  ...
  const std::string &on_owner_receive_dmg_future2_do(void);
  const std::string &on_owner_receive_dmg_future3_do(void);
  ...
  const std::string &on_receiving_dmg_future2_do(void);
  const std::string &on_receiving_dmg_future3_do(void);
  ...
  int damage_future2_chance_d1000(int);
  int damage_future2(void);
  int damage_future3_chance_d1000(int);
  ...
  int on_attacking_dmg_future2(Thingp victim, int damage);
  int on_attacking_dmg_future3(Thingp victim, int damage);
  ...
  int on_owner_attack_dmg_future2(Thingp owner, Thingp victim, int damage);
  int on_owner_attack_dmg_future3(Thingp owner, Thingp victim, int damage);
  ...
  int on_owner_receive_dmg_future2(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  int on_owner_receive_dmg_future3(Thingp owner, Thingp hitter, Thingp real_hitter, int damage);
  ...
  int on_receiving_dmg_future2(Thingp hitter, Thingp real_hitter, int damage);
  int on_receiving_dmg_future3(Thingp hitter, Thingp real_hitter, int damage);
  ...
  int total_damage_for_on_attacking_dmg_future2(Thingp victim, int damage);
  int total_damage_for_on_attacking_dmg_future3(Thingp victim, int damage);
  ...
  int total_damage_for_on_receiving_dmg_future2(Thingp hitter, Thingp real_hitter, int damage);
  int total_damage_for_on_receiving_dmg_future3(Thingp hitter, Thingp real_hitter, int damage);

...
LEVEL_BODY_GET_BOOL_AT(level_gfx_pixelart_flickers_at, gfx_pixelart_flickers)
...
LEVEL_BODY_GET_BOOL_AT(level_is_ait_breather_at, is_ait_breather)
...
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_shown_as_gray_in_shadow_at, gfx_ascii_shown_as_gray_in_shadow)
LEVEL_BODY_GET_BOOL_AT(level_unused_flag8_at, unused_flag8)
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_shown_in_bg_at, gfx_ascii_shown_in_bg)
LEVEL_BODY_GET_BOOL_AT(level_gfx_ascii_fade_with_dist_at, gfx_ascii_fade_with_dist)
LEVEL_BODY_GET_BOOL_AT(level_is_jump_blocker_at, is_jump_blocker)

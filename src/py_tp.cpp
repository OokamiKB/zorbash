...
TP_BODY_SET_INT(hunger_starving_pct)
...
TP_BODY_SET_INT(is_ait_breather)
...
TP_BODY_SET_STRING(on_attacking_dmg_future2_do)
TP_BODY_SET_STRING(on_attacking_dmg_future3_do)
...
TP_BODY_SET_STRING(on_owner_attack_dmg_future2_do)
TP_BODY_SET_STRING(on_owner_attack_dmg_future3_do)
...
TP_BODY_SET_STRING(on_owner_receive_dmg_future2_do)
TP_BODY_SET_STRING(on_owner_receive_dmg_future3_do)
...
TP_BODY_SET_STRING(on_receiving_dmg_future2_do)
TP_BODY_SET_STRING(on_receiving_dmg_future3_do)
...
TP_BODY_SET_STRING(on_get_description_do)

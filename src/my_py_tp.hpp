...
TP_SET_PROTO(hunger_starving_pct)
...
TP_SET_PROTO(on_attacking_dmg_future1_do)
TP_SET_PROTO(on_attacking_dmg_future2_do)
TP_SET_PROTO(on_attacking_dmg_future3_do)
...
TP_SET_PROTO(on_owner_attack_dmg_future1_do)
TP_SET_PROTO(on_owner_attack_dmg_future2_do)
TP_SET_PROTO(on_owner_attack_dmg_future3_do)
...
TP_SET_PROTO(on_owner_receive_dmg_future1_do)
TP_SET_PROTO(on_owner_receive_dmg_future2_do)
TP_SET_PROTO(on_owner_receive_dmg_future3_do)
...
TP_SET_PROTO(on_receiving_dmg_future1_do)
TP_SET_PROTO(on_receiving_dmg_future2_do)
TP_SET_PROTO(on_receiving_dmg_future3_do)
...
TP_SET_PROTO(on_get_description_do)

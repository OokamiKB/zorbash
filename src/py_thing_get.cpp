...
THING_BODY_GET_BOOL(thing_gfx_ascii_animated, gfx_ascii_animated)
THING_BODY_GET_BOOL(thing_gfx_ascii_color_is_animated, gfx_ascii_color_is_animated)
THING_BODY_GET_BOOL(thing_gfx_ascii_fade_with_dist, gfx_ascii_fade_with_dist)
...
THING_BODY_GET_BOOL(thing_gfx_pixelart_anim_synced_with_owner, gfx_pixelart_anim_synced_with_owner)
THING_BODY_GET_BOOL(thing_gfx_pixelart_flickers, gfx_pixelart_flickers)
THING_BODY_GET_BOOL(thing_gfx_pixelart_health_bar_only_when_awake, gfx_pixelart_health_bar_only_when_awake)
THING_BODY_GET_BOOL(thing_gfx_pixelart_shadow_long, gfx_pixelart_shadow_long)
THING_BODY_GET_BOOL(thing_gfx_pixelart_shadow_solid, gfx_pixelart_shadow_solid)
THING_BODY_GET_BOOL(thing_gfx_pixelart_shadow_very_short, gfx_pixelart_shadow_very_short)
THING_BODY_GET_BOOL(thing_gfx_pixelart_show_asleep_anim, gfx_pixelart_show_asleep_anim)
THING_BODY_GET_BOOL(thing_gfx_pixelart_wobbles_when_hit, gfx_pixelart_wobbles_when_hit)
...
THING_BODY_GET_BOOL(thing_is_able_to_use_wands_or_staffs, is_able_to_use_wands_or_staffs)
...
THING_BODY_GET_BOOL(thing_is_ait_breather, is_ait_breather)
...
THING_BODY_GET_BOOL(thing_is_green_blood_eater, is_green_blood_eater)
...
THING_BODY_GET_BOOL(thing_is_jump_blocker, is_jump_blocker)
...
THING_BODY_GET_BOOL(thing_is_obstacle_when_dead, is_obstacle_when_dead)
...
THING_BODY_GET_BOOL(thing_is_pack, is_pack)
...
THING_BODY_GET_BOOL(thing_is_red_blood_eater, is_red_blood_eater)
...
THING_BODY_GET_BOOL(thing_is_temperature_change_sensitive, is_temperature_change_sensitive)
THING_BODY_GET_BOOL(thing_is_temperature_sensitive, is_temperature_sensitive)
...
THING_BODY_GET_BOOL(thing_temperature, temperature)
...
THING_BODY_GET_INT(thing_damage_future1, damage_future1)
THING_BODY_GET_INT(thing_damage_future2, damage_future2)
THING_BODY_GET_INT(thing_damage_future3, damage_future3)

...
def tp_init(name, text_long_name, text_short_name):
    ...
    my.text_long_description(self, "Lime scale armor. This armor is coverted with a fine chalky deposit, giving a very tough exterior. However, once that layer flakes off, you're left with little protection.")
    my.text_long_description2(self, "Good short term armor")
